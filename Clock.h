...
static void Select_Clock(CLOCK str);
// Chinh lai tan so DCO,sau khi tinh
// CHU Y :xung clock bi thay doi
// Delta = Tan so/ 4096
//Tan so Calib toi thieu la 100Khz,
//Tan so toi thieu cua CPU khoang 10Khz do chia tan ACLK
static void Set_DCO(unsigned int Delta,unsigned int* var_DCO,unsigned int* var_BCS);
static void Calib_DCO();
/******************************************************************************\
...
{
	__delay_cycles(20000);	//Tranh loi tu cac hoat dong chua hoan tat
